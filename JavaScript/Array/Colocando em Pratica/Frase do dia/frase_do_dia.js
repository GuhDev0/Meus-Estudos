...
]// Aqui esta Armezado as Frase dentro de uma Array
var data_atual = new Date();//Aqui estou criando uma Var que vai receber o Data Atual 
                            //Como new Date() é formato (dezembro 13,2023)                    
var dia_escolhido = data_atual.getDate();// Aqui a Var Vai receber o Dia atual do mes Com o (getDate)

console.log(`Numero Sorteado ${dia_escolhido}`);
dia_escolhido--;//Aqui estou decrementando Por simples Motivo da Array Começar a Conta do Numero 0 ou Seja 1 de Dezembro seria a Frase 0

frase_do_dia = frase_do_dia[dia_escolhido];// Aqui ela vai procurar a frase dentro da frase_do_dia(array) De Acordo com o dia_escolhido(dia atual)
